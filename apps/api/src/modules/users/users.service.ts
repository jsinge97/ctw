import type { UserDto } from "@ctw/contracts";
...
export function inviteUser(input: { email: string; role: UserDto["role"]; name: string }): UserDto {
...
export function updateUser(userId: string, input: Partial<UserDto>): UserDto {
